...
*Dana/Indosat/Gopay = ${085742011667}*
*QRis yang dilampirkan*
*PAYPAL = yusufilhamdermawan7988@gmail.com*

*_note_*:
*Jika kalian ingin menjadi owner bot,bisa chat owner untuk price nya :D*
*wa.me/${085742011667} (Yusuf)*

    `
}

exports.UpToPremi = (085742011667, prefix) => {
    return `
*── 「 UPGRADE PREMIUM 」 ──*
...
*_note_*:
*Pembelian Premium yang disertai SewaBot hanya akan membayar 25K (Diskon 5K)*
...
exports.tos = (085742011667, prefix) => {
    return `
*── 「 DONATE 」 ──*

Kalian bisa mendukung saya agar bot ini tetap up to date dengan:
085742011667 (Dana/Indosat/GoPay)
